...
export const Header = () => {
	return (
		<header className="background-container py-2 flex justify-around items-center border-b-2 border-white border-opacity-10 md:mb-6 md:justify-center md:gap-6">
			<div
